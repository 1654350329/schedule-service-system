...
public class ImgUtil {
    ...
    public static void main(String[] args) {
        ...
        try {
            File file = compressPictureByQality(new File("D:\\image\\f7fdd17e2b1b293bfef38f3965eae8d9\\2022\\04\\06\\20220406175200.jpg"), 0.07f);
...
//                colorModel, colorModel.createCompatibleSampleModel(16, 16)));
        ...
        if (!file.exists()) {
            ...
            out.flush();
            out.close();
            logger.debug("图片转换后大小" + file1.length() + "字节");
            return file1;
        }
    }
